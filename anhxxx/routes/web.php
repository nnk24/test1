...
Route::group(['prefix'=>'admin'], function () {
    ...
    Route::group(['prefix'=>'message'], function () {
        Route::get('/{id}', 'backend\MessageController@index')->name('view.message');
        Route::post('/deleteAll', 'backend\MessageController@deleteAll')->name('view.deleteAll');
        Route::get('/delete/{id}', 'backend\MessageController@delete')->name('view.delete');
    });
});
