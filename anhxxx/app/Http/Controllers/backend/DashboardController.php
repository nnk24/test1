...
class DashboardController extends Controller
{
    ...
    {
        $messages = Messages::orderby('status', 'DESC')->orderby('id', 'DESC')->paginate(10);
        $count_messesage = Messages::where('status', 1)->count();
        $ips = Messages::groupby('ip')->pluck('ip');
//        $today = Views::all()
...
//end day 8
        ...
        return view('backends.dashboard.index', compact('days', 'views', 'pictures', 'count_messesage', 'ips', 'messages'));
    }
}
